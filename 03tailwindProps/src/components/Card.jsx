...
function Card({titleName, avail="In Stock"}){
    return (

        <div class="flex font-sans">
        <div class="flex-none w-56 relative">
          <img src="https://cdn.pixabay.com/photo/2015/04/23/22/00/new-year-background-736885_1280.jpg" alt="" class="absolute inset-0 w-full h-full object-cover rounded-lg" loading="lazy" />
        </div>
